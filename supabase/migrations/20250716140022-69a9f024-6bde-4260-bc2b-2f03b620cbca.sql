-- Primeiro, vamos criar uma função SECURITY DEFINER para verificar se um usuário é admin
...
-- Atualizar a função is_admin existente para usar a nova implementação
